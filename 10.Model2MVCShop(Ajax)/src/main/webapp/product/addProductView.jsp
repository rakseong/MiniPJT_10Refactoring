...
$(function(){
	...
	$(".ct_btn01:contains('등록')").on('click',function(){
		...
		$("form:first").attr("enctype","multipart/form-data").attr("method","POST").attr("action","/prod/addProduct").submit();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input	multiple="multiple"	type="file" name="files" class="ct_input_g" 
